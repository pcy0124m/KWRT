#!/bin/bash
# =================================================
# Kwrt diy.sh - 官方版（自包含修正）
# 来源: kiddin9/Kwrt 25.12 devices/common/diy.sh
# 作用: 添加 op-packages 插件库 + 打补丁 + feeds 更新
# 说明: 已内置 git_clone_path 函数, 无需外部定义;
...
sed -i "s/192.168.1/192.168.12/" package/base-files/files/bin/config_generate
